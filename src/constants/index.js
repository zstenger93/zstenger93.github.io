...
const experiences = [
  {
    ...
    language: "Languages/Tools: Cognigy, MongoDB, Grafana, Monitoring, Logging",
    icon: sit,
    iconBg: "#E6DEDD",
    date: "June 2024 - November 2024",
    points: [
      "Got familiar with conversational AI.",
      "Visualizing the data on MongoDB from the bots for a better understanding of their performance on Grafana.",
